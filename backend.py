...
class StockMarket:
    ...
    def add_stock(self, stock_name:str, start_price:int):
        ...
        db.insert("stock_list", {"stock":stock_name, "price":start_price, "holdings":0, "market_cap":0, "history":f"[{start_price}]"})
        db.close()
    ...
    def update_stock_price(self, stock):
        ...
        db.update("stock_list", {"price":price, "market_cap":price*stock_data[2], "history":repr(history)}, where={"stock":stock})
        db.close()
